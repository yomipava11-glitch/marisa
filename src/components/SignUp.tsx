...
export function SignUp({ onToggleMode }: { onToggleMode: () => void }) {
    ...
    const handleSignUp = async (e: React.FormEvent) => {
        ...
        // Using Supabase Auth to Sign Up and pass full_name in metadata
        ...
        if (error) {
            ...
            confetti({
                ...
                spread: 70,
                origin: { y: 0.6 },
                colors: ['#00a651', '#ffffff', '#00b95b'], // Vert primaire de l'application
                zIndex: 9999
            });

            // Afficher l'alerte après un léger délai pour profiter de l'animation
            setTimeout(() => {
            ...
            <div className="content-wrapper">
                <div className="logo-container">
                    <div className="logo-box">
                        <span className="material-symbols-outlined logo-icon">person_add</span>
                    </div>
                </div>
                ...
                <div className="glass-card">
                    <div className="header-text">
                        ...
                        <p className="header-subtitle">Join us to manage tasks</p>
                    </div>
                ...
                <p className="signup-text">
                    Already have an account? <span onClick={onToggleMode} className="signup-link" style={{ cursor: 'pointer' }}>Sign In</span>
                </p>
            </div>
        </div>
    );
